...
<body>
    ...
    <nav>
        <ul>
            <li><a <?php isActive("index.php")?> href="index.php">Home</a></li><li><a <?php isActive("archivio.php")?> href="archivio.html">Archivio</a></li><li><a <?php isActive("contatti.php")?> href="contatti.html">Contatti</a></li><li><a <?php isActive("login.php")?> href="login.php">Login</a></li>
        </ul>
    </nav>
    <main>
    <?php
